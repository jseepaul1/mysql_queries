...
SELECT countries.name, COUNT(countries.id) FROM countries 
...
FROM countries
WHERE countries.capital > 200 AND countries.life_expectancy > 75 AND government_form = 'Constitutional Monarchy';
